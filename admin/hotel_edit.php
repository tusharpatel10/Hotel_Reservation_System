...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($errorMsg)) {
        ...
        if ($result) {
            echo "<script>window.location.href='view_rooms.php?updateSuccessMsg=Hotel updated successfully !'</script>";
        } else {
            echo "<script>window.location.href='view_rooms.php?updateErrorMsg=Error, Please try again !'</script>";
        }
    }
}
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-start-0 ps-0" id="hotel_name" name="hotel_name" value="<?php echo $old_row['HotelName']; ?>" placeholder="Enter hotel name" value="<?= isset($_POST['hotel_name']) ? htmlspecialchars($_POST['hotel_name']) : '' ?>">
                                </div>
                            </div>
                            ...
                            <div class="d-flex gap-2 justify-content-end">
                                <button type="submit" class="btn btn-primary px-4">
                                    <i class="bi bi-plus-circle me-1"></i> Save Room
                                </button>
                            </div>
                        </form>
                    </div>
